...
import "./GridHolyGrail.css"

function GridHolyGrailTag (props) {
    return (
        <article id={"GridHolyGrail"}>

            <header id={"GridHolyGrailheader"}>
                <h2 id={"GridHolyGrailh2"}>Header</h2>
                <ul id={"GridHolyGrailul"}>
                    <li id={"GridHolyGrailli"}>Home</li>
                    <li id={"GridHolyGrailli"}>News</li>
                    <li id={"GridHolyGrailli"}>Contact</li>
                    <li id={"GridHolyGrailli"}>About</li>
                </ul>
            </header>

            <div className="GridHolyGrailcontent">
                <div className="GridHolyGrailleft">
                    left<br/>
                    menu<br/>
                    with<br/>
                    many<br/>
                ...
                <div className="GridHolyGrailcenter">
                ...
                <div className="GridHolyGrailright">
                    right
                </div>

                <footer id={"GridHolyGrailfooter"}>
                    Footer: <a id={"GridHolyGraila"} href="Sitemap.html">Sitemap</a> <a id={"GridHolyGraila"} href="Sitemap.html">Home</a> <a id={"GridHolyGraila"}
                    href="Sitemap.html">News</a> <a id={"GridHolyGraila"} href="Sitemap.html">Contact</a> <a id={"GridHolyGraila"} href="Sitemap.html">About</a>
                </footer>
...
export default GridHolyGrailTag